...
import SpotDetails from "../SpotDetailPage/spotDetails";
...
export function SpotDetailsDrawer({
  ...
  const [snapDetails, setSnapDetails] = useState<number | string | null>(
    snapPoints[2]
  );
  ...
  return (
    ...
    >
      <Drawer.Portal>
        ...
        <Drawer.Content className="z-500 bottom-0 h-dvh bg-white flex flex-col rounded-t-4xl fixed left-0 right-0 outline-none border-t-4">
          ...
          <div
            aria-hidden
            className=" z-50 left-50 mx-auto mt-3 w-12 h-1 flex-shrink-0 rounded-full bg-gray-300 mb-1"
          />
          {/* </div> */}
          {/* Close button */}

          <div
            className="flex justify-between items-center border-b-5 px-4"
            style={{
