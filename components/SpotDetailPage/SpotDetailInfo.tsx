  ...
  return (
    <div className="w-full flex flex-col bg-white">
      ...
      <div className="px-4 py-4 space-y-4">
        {/* Ideal Time */}
        {selectedLocation.SpotDetails?.idealTime &&
          selectedLocation.SpotDetails.idealTime.length > 0 && (
        ...
        {/* Friendly Indice */}
        {selectedLocation.SpotDetails?.friendlyIndice !== null &&
          selectedLocation.SpotDetails?.friendlyIndice !== undefined && (
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2">
                  <div className="text-sm text-gray-600">
                    {getFriendlyLabel(
                      selectedLocation.SpotDetails.friendlyIndice || 3
                    )}
                  </div>
